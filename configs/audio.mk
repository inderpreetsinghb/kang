...
ALARM_PATH := vendor/kang/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/kang/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/kang/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/kang/prebuilt/common/media/audio/ui
